...
class DesignWorkflowStore:
    ...
    def list_briefs(self, brand_filter: Optional[str] = None) -> list[Brief]:
        with self._connect() as conn, conn.cursor() as cursor:
            params = []
            where_clause = ""
            if brand_filter:
    ...
    def list_design_jobs(
        self, brief_id: Optional[str] = None, status_filter: Optional[str] = None
    ...
    def list_design_options(
        self, brief_id: Optional[str] = None, job_id: Optional[str] = None
    ) -> list[DesignOption]:
        with self._connect() as conn, conn.cursor() as cursor:
            params = []
            conditions = []
