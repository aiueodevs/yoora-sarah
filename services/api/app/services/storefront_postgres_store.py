...
from app.schemas.catalog import CatalogCategory, CatalogProductColor, CatalogProductDetail
from app.schemas.catalog import StorefrontAccountHighlight, StorefrontQuickLink
